...
public class NonDurationEvent extends Event {
	...
	public NonDurationEvent(int timelineID, int eventID, String eventTitle, LocalDateTime eventStart_time, LocalDateTime eventEnd_time, String description, int imageID, Color color) {
